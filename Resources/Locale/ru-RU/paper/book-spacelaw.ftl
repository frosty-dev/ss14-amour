book-text-spacelaw =
    ...
    407 - Враг корпорации
        Действовать как враг НаноТрейзен либо сотрудничать с тем кто таковым является. Обратите внимание, что это одно из немногих преступлений, за которое вы можете казнить человека без суда и следствия, если он представляет значительный риск.
