...
petting-failure-bat = Вы тянетесь погладить { $target }, но { POSS-ADJ($target) } очень трудно поймать!
...
petting-failure-holo = Вы тянетесь погладить { $target }, но { SUBJECT($target) } едва не пронзает шипами вашу руку!
...
petting-failure-nymph = Вы протягиваете руку, чтобы погладить { $target }, но { SUBJECT($target) } отодвигает свои ветки от вас.
petting-failure-shadow = Вы пытаетесь погладить {$target}, но ваша рука проходит сквозь холодную темноту { POSS-ADJ($target) } тела.
...
petting-success-engineer-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } отражающей металлической голове.
...
petting-success-service-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } опрятной металлической голове.
petting-success-syndicate-cyborg = Вы гладите { $target } по { POSS-ADJ($target) } угрожающей металлической голове.
...
petting-failure-mimebot = Вы тянетесь погладить { $target }, но { SUBJECT($target) } занят мимикацией!
petting-failure-medibot = Вы тянетесь погладить { $target }, но { SUBJECT($target) } едва не пронзает вашу руку шприцом!
petting-failure-generic-cyborg = Вы тянетесь погладить { $target }, но { SUBJECT($target) } занят оглашением своих законов!
...
petting-failure-service-cyborg = Вы тянетесь погладить { $target }, но { SUBJECT($target) } занят обслуживанием других!
petting-failure-syndicate-cyborg = Вы тянетесь погладить { $target }, но { POSS-ADJ($target )} коварные тенденции заставляют вас передумать.

## Rattling fences

fence-rattle-success = *трещит*
...
petting-failure-tesla = Вы тянетесь погладить { $target }, но { SUBJECT($target) } шокирует вашу руку.
