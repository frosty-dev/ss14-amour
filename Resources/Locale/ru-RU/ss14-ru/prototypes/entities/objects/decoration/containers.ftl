...
ent-ShippingContainerNanotrasen = грузовой контейнер НаноТрейзен
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображен логотип компании НаноТрейзен, и поэтому внутри может быть что угодно.
...
ent-ShippingContainerCybersun = грузовой контейнер Киберсан Индастриз
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображен логотип компании Киберсан, и поэтому внутри может быть что угодно.
