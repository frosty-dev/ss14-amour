...
ui-options-vp-vertical-fit-tooltip = Если включено, основная область просмотра будет полностью игнорировать горизонтальную
                                     ось при подгонке под ваш экран. Если ваш экран меньше области просмотра, то это
...
ui-options-function-toggle-round-end-summary-window = Открыть итоги раунда
