...
ent-PosterLegitVacation = Корпоративные льготы НаноТрейзен: Отпуск
...
ent-PosterLegitNTTGC = Карты тактической игры от НаноТрейзен
   .desc = Реклама карт TCG от НаноТрейзен: ПОКУПАЙТЕ БОЛЬШЕ КАРТ.
