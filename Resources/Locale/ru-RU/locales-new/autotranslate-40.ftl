...
ent-BannerSyndicate = баннер синдиката
   .desc = Баннер, от которого, по мнению синдиката, должна возникнуть ненависть к НТ.
ent-Bonfire = костер
...
ent-AirlockExternalGlassNukeopLocked = { ent-AirlockExternal }
   .desc = { ent-AirlockExternal.desc }
ent-AirlockExternalGlassSyndicateLocked = { ent-AirlockExternal }
   .desc = { ent-AirlockExternal.desc }
ent-AirlockExternalNukeopLocked = { ent-AirlockExternal }
   .desc = { ent-AirlockExternal.desc }
ent-AirlockExternalSyndicateLocked = { ent-AirlockExternal }
   .desc = { ent-AirlockExternal.desc }
ent-AirlockExternalShuttleNukeopLocked = { ent-AirlockGlassShuttle }
   .desc = { ent-AirlockGlassShuttle.desc }
ent-AirlockExternalShuttleSyndicateLocked = { ent-AirlockGlassShuttle }
   .desc = { ent-AirlockGlassShuttle.desc }
ent-AirlockExternalGlassShuttleNukeopLocked = { ent-AirlockGlassShuttle }
   .desc = { ent-AirlockGlassShuttle.desc }
ent-AirlockExternalGlassShuttleSyndicateLocked = { ent-AirlockGlassShuttle }
   .desc = { ent-AirlockGlassShuttle.desc }
