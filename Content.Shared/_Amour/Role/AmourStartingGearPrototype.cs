...
namespace Content.Shared._Amour.Role;

[Prototype]
public sealed partial class AmourStartingGearPrototype : IPrototype, IInheritingPrototype
{
    /// <inheritdoc/>
    [ViewVariables]
    [IdDataField]
    ...
    /// <inheritdoc/>
    [ParentDataField(typeof(AbstractPrototypeIdArraySerializer<AmourStartingGearPrototype>))]
