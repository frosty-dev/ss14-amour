...
public abstract class SharedStationSpawningSystem : EntitySystem
{
    ...
    public void EquipStartingGear(EntityUid entity, AmourStartingGearPrototype? startingGear,
        HumanoidCharacterProfile? profile, bool raiseEvent = true)
    {
