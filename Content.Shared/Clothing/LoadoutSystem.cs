using System.Linq;
using Content.Shared._Amour.NeTrogat;
...
public sealed class LoadoutSystem : EntitySystem
{
    ...
    [Dependency] private readonly AmourActorSystem _amour = default!;
    ...
    private void OnMapInit(EntityUid uid, LoadoutComponent component, MapInitEvent args)
    {
        ...
        if (component.StartingGear != null)
        {
            ...
            _station.EquipStartingGear(uid, gear, null);
            return;
        }
        ...
        loadout.SetDefault(GetProfile(uid), _amour.GetSession(uid), _protoMan, true);
