...
public sealed partial class DefaultGameScreen : InGameScreen
{
    public DefaultGameScreen()
    {
        ...
        // ETO PIZDEC
        Actions.ActionsBox.Orientation = BoxContainer.LayoutOrientation.Vertical;
        Actions.ActionsContainer.VerticalAlignment = VAlignment.Center;
        Actions.ActionsContainer.MaxSize = new Vector2(64, 9999);
        Actions.ActionsContainer.Columns = 1;
        Actions.ActionsContainer.Rows = 10;
        Actions.PageButtons.PageButtonsContainer.Orientation = BoxContainer.LayoutOrientation.Horizontal;
        Actions.PageButtons.LeftArrow.TexturePath = "left_arrow.svg.192dpi";
        Actions.PageButtons.RightArrow.TexturePath = "right_arrow.svg.192dpi";
