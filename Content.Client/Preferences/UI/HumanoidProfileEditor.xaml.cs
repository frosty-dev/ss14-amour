    ...
    public sealed partial class HumanoidProfileEditor : Control
    {
       ...
       private Button _nameBorgRandomButton => CBorgNameRandomize;
            ...
            IEntityManager entityManager, IConfigurationManager configurationManager)
        {
            ...
            foreach (var proto in prototypeManager.EnumeratePrototypes<RoleplayThinkPrototype>())
            {
                var think = new RolePlaySelector(proto.Name, proto.Description, proto.ID);
        ...
        private sealed class RolePlaySelector : Control
        {
            ...
            public RolePlaySelector(string title,string description, string rolePlayId)
            {
        ...
        {
            foreach (var selection in _roleplaySelections)
            {
                var id = selection.RolePlayId;

                var preference = Profile?.RoleplaySelections.GetValueOrDefault(id, RoleplaySelection.No) ??
                                 RoleplaySelection.No;
